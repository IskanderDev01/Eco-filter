...
import { useGetClients } from 'pages/MainPage/model/api/clientsApi';
        ...
        <div className="bg-slate-50 text-slate-950 py-4 shadow-slate-300 shadow-sm fixed w-full z-50">
            <div className="container mx-auto max-w-screen-xl flex">
                ...
                <div className="basis-1/4 flex justify-end items-center">
                    <Button onClick={handleOpenModal} className="py-5 hover: !border-inherit">
                        <FontAwesomeIcon icon={faUserPlus} />
                    </Button>
                    <Button onClick={logout} className="py-5  ml-2 hover:!border-red-500 hover:!text-red-500">
